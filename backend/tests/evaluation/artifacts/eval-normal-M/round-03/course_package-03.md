...
| 9 | `summary_card` | 自适应 | len(knowledge_sub_nodes)=3>=3 | 制度基础速查卡｜专利基础分析遵循“制度目的和规范体系在前，客体拆分与程序识别在后”的顺序；真实案例以可核验证… | [B] |
...
你希望结合智能制造领域的真实案例学习新颖性判断和侵权判定。当前检索上下文仅提供法条、审查指南和学习材料，未提供可核验的机器人抓取系统或其他智能制造专利案件的专利号、公开专利文献、裁判文书或具体案件事实。因此，本节不能把未经检索核验的企业新闻或教学情境称为“真实案例”，也不能编造对应的专利号或裁判结论。本节先用教学拟制的视觉引导机械臂场景建立制度坐标；待补充获得可核验的公开专利文献或裁判材料后，再在后续专题中进行真实案例演示。

学习者希望进一步学习新颖性判断和侵权判定，但本节的唯一主节点是“专利法律制度基础”。因此，本节先建立后续判断所需的制度坐标，不直接对某项技术是否具有新颖性或某项实施行为是否构成侵权作实体结论。
...
下一学习节点将深入新颖性判断，围绕申请日、优先权日、现有技术、抵触申请与单独对比建立判断顺序；随后进入专利权保护与侵权分析，围绕有效专利权、权利要求保护范围和具体实施行为建立分析框架。后续案例演示应使用能够核验的公开专利文献或裁判材料；当前检索上下文尚未提供具体智能制造真实案件，因此本节不提前虚构案例事实或结论。

本节设有测评，请到【习题】区作答。

### 智能制造研发的专利分类起点（anchor_scenario）

> 教学拟制场景：协作机器人抓取单元包含视觉引导轨迹控制方法、快换夹具锁止结构和夹具局部外观。研发团队希望同时布局专利，却不确定应如何分类。当前检索上下文未提供可核验的智能制造真实专利案件、专利号或裁判文书，因此不能把具体企业故事冒充真实案例。

**锚定**：同一设备中的方法、结构和外观并置，便于直观看到专利客体不能按行业名称一概而论。关于真实智能制造案例，当前检索上下文仅有法条和教学材料，尚不足以形成可核验案例；后续应以补充检索到的公开专利文献或裁判材料为准。
...
**结论**：在缺少公开专利文献或裁判材料的情况下，本例只能作为教学拟制情境，结论限于客体分类：轨迹校正方法可沿发明方向识别，锁止构造可沿实用新型方向识别，局部纹理可沿外观设计方向识别。
**本题要点**：先拆分方法、构造和外观，再进入各类型的授权与保护规则；真实案例必须以可核验公开专利文献或裁判材料为依据。
...
- 规范体系：专利法提供基本规则，实施细则和审查指南承接具体程序与审查要求。
- 保护客体：发明对应产品、方法或其改进的技术方案；实用新型对应产品构造；外观设计对应产品整体或局部外观。
- 制度作用：以公开换取法定保护，推动技术信息传播和后续创新。
- 制度特点：发明申请存在公布和实质审查路径；初步审查与实质审查并存。
- 真实案例边界：当前检索上下文未提供具体智能制造专利号、公开专利文献或裁判文书，不能据此虚构真实案例；后续补充检索获得可核验材料后再进行案例演示。
**概念关系**：专利法、实施细则与审查指南处于不同规范层次。；客体分类在前，审查路径和授权条件分析在后。；新颖性与侵权属于后续专题，均不能仅以产品名称或技术领域直接下结论。
**必记**：先定客体，再谈授权条件、新颖性或侵权。；发明和实用新型适用第二十二条的三性；外观设计适用第二十三条的不同条件。；真实智能制造案例应以公开专利文献或裁判材料核验为前提；当前检索上下文未提供此类具体案例。

### 制度基础速查卡（summary_card）

**要点卡**：
- **制度目的**：保护合法权益，也通过鼓励创造和推动应用服务科技与经济社会发展。
- **规范体系**：专利法提供基本规则，实施细则和审查指南承接细化规则。
- **三类客体**：发明看方法或技术方案，实用新型看产品构造，外观设计看产品外观。
- **三性边界**：新颖性、创造性、实用性适用于发明和实用新型，不能直接套用于外观设计。
- **制度特点**：发明申请存在公布与实质审查路径，初步审查与实质审查并存。
- **真实案例**：没有可核验的公开专利文献或裁判材料时，不把拟制场景称为真实案件。
**必背**：先定客体，再谈条件。；方法、构造、外观应分别识别。；本节不直接作新颖性或侵权实体结论。；真实智能制造案例必须有公开专利文献或裁判材料支撑。
**一句话总结**：专利基础分析遵循“制度目的和规范体系在前，客体拆分与程序识别在后”的顺序；真实案例以可核验证据为前提。
...
[
  ...
  {
    "risk": "将未经公开专利文献或裁判材料核验的智能制造企业故事误当作真实专利案例；当前检索上下文不足以支持具体真实案例陈述。",
    "related_node_id": "patent-law-foundation"
  }
]
```
