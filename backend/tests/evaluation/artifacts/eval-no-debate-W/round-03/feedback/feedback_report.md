...
```json
[
  "请用自己的话区分“专利法基础”和“专利制度概览”各自解决的核心问题。",
  "如果把同一事实放入专利申请流程和专利权性质两个语境，你会先看哪个线索来判断适用规则？"
]
```
...
```json
{
  "questions": [
    ...
    "题干中的术语密度是否足以帮助你定位规则，还是需要更明确的对比提示？",
    "你更希望下一轮继续保持同类选择题，还是加入一题短案例判断？"
  ],
  "evaluation_signals": [
    "本轮未见明显犹豫或反复修改答案的信号",
    "当前作答模式更偏向稳定识别而非即时试错"
  ],
  "feeds": "这些信号说明现阶段节奏可以维持中等偏快，但下一轮最好加入一题需要跨节点比较的题，以确认不是只对熟悉表述做出匹配。"
}
```
