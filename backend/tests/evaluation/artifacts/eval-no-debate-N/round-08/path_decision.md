...
- 决策：`keep`
- 决策原因：候选路线已覆盖当前长期目标所需的核心先修闭包，且顺序符合静态DAG；当前无需为弱点额外改线。
...
- 类型：薄弱点跟进
- 触发：若本轮对新颖性/创造性或修改超范围出现连续错误，说明核心判断链条尚未稳定。
- 动作：下一轮优先回补 novelty、inventive-step、office-action-response 相关节点，并压缩低权重基础节点停留时间。
