...
可以把材料成果的分类理解为：先为电池隔膜成果选择正确的“入口”，再决定后续应走的审查路径。配方或制备方法先看是否为技术方案，隔膜层状结构先看是否为产品构造，外壳纹样再看是否为视觉设计；入口选定后，发明和实用新型才进入新颖性、创造性和实用性的审查框架。
...
```json
{
  ...
  "learner_id": "d8f98fc5d279488d9f8bbdbdd7b00d61",
  "blocks": [
    {
      "block_id": "anchor_scenario-1",
      "block_type": "anchor_scenario",
      "title": "材料研发成果的专利分类场景",
      "payload": {
        "scenario": "某材料研发团队制备出一种用于锂离子电池隔膜的陶瓷涂层：该涂层由特定粒径范围的氧化铝颗粒与粘结剂组成，能够提高耐热收缩性能。团队一方面考虑把“涂层配方”和“制备方法”作为发明申请，另一方面考虑把“隔膜的层状结构”作为实用新型申请，还制作了具有特定纹样的电池外壳。\n\n团队需要先区分：哪些技术成果属于发明、实用新型或外观设计这一不同保护客体；即使属于保护客体，申请的发明或实用新型还要满足新颖性、创造性和实用性等授权条件。",
        "why_anchor": "该情境锚定专利保护客体的分类，以及材料技术方案进入后续授权审查前的基础制度边界。",
        "think_prompt": "面对同一套材料研发成果，首先应按技术方案、产品结构还是产品视觉设计来判断其可能对应的专利类型。"
      },
      "chosen_by": "[A]",
      "trigger": "perception=sensing(0.82) / cold_start",
      "rationale": "以材料研发事实建立保护客体与授权条件的初步区分。",
      "adapts_to": [
        "感知型学习偏好",
        "冷启动"
      ],
    ...
    },
    {
      ...
      "payload": {
        ...
        "plain_summary": [
          "专利制度的立法目的包括保护专利权人合法权益、鼓励发明创造、推动应用，并促进科学技术进步和经济社会发展。",
          "中国专利法将发明创造分为发明、实用新型和外观设计；三类客体的法定定义不同。",
          "国务院专利行政部门统一受理和审查专利申请，并依法授予专利权。",
          "发明和实用新型取得专利权须具备新颖性、创造性和实用性；现有技术是申请日以前在国内外为公众所知的技术。"
        ],
        "why_it_matters": "材料领域申请首先要明确成果落入何种保护客体，再进入相应审查路径。第二十二条是理解后续新颖性、创造性判断的法定入口。"
      },
      "chosen_by": "[A]",
      "trigger": "mandatory",
      "rationale": "以已检索法条建立本节点的可核验制度基础。",
      "adapts_to": [],
      "source": "中华人民共和国专利法.txt：第一条、第二条、第三条、第二十二条"
    },
    {
      "block_id": "worked_example-1",
      "block_type": "worked_example",
      "title": "材料成果的客体分类演示",
      "payload": {
        "problem": "某团队形成三项成果：一种通过调整氧化铝颗粒粒径和粘结剂比例提高隔膜耐热性的涂层配方；一种由基层、陶瓷层和功能层构成的隔膜结构；一种具有新纹样和色彩组合的电池外壳。现需在提交申请前对三项成果作专利保护客体的初步分类，并确定哪些成果将面对新颖性、创造性和实用性审查。",
        "applicable_rule": "《中华人民共和国专利法》第二条规定发明创造包括发明、实用新型和外观设计；第二十二条规定发明和实用新型应具备新颖性、创造性和实用性。",
        "steps": [
          {
            "reasoning": "先识别涂层配方及其制备工艺的表达对象。它们属于针对产品、方法或者改进提出的技术方案，符合发明的法定定义方向。",
            "summary": "配方和制备工艺优先按发明方向评估。"
          },
          {
            "reasoning": "再识别隔膜层状结构的表达对象。该成果聚焦产品的形状、构造或者其结合，且具有实用目的，符合实用新型的法定定义方向。",
            "summary": "产品结构优先按实用新型方向评估。"
          },
          {
            "reasoning": "最后识别外壳纹样和色彩组合的表达对象。其核心是产品整体或者局部的形状、图案及色彩组合形成的设计，属于外观设计的法定分类方向。",
            "summary": "视觉设计优先按外观设计方向评估。"
          },
          {
            "reasoning": "对前两类成果，第二十二条要求授予专利权的发明和实用新型具备新颖性、创造性和实用性；外观设计适用第二十三条所列条件。",
            "summary": "先分客体，再适用对应授权条件。"
          }
        ],
        "conclusion": "该材料研发项目中的配方和制备方法可按“发明”方向评估，隔膜层状结构可按“实用新型”方向评估，外壳视觉设计可按“外观设计”方向评估；其中发明和实用新型仍须进入第二十二条的三性审查。",
        "takeaway": "迁移到其他成果时，仍按“先找表达对象，再对照第二条定义，最后确定相应授权条件”的清单判断。对于软件算法等成果，本节点仅能提示先核对其是否构成产品、方法或者改进的技术方案；能否获得专利保护还须依据后续对应规则和正式文本判断，不能仅凭名称下结论。"
      },
      "chosen_by": "[A]",
      "trigger": "cold_start(low_confidence)",
      "rationale": "用材料技术事实演示从成果特征到法定客体、再到审查条件的线性推理，并保留可迁移的判断清单。",
      "adapts_to": [
        "低置信度冷启动",
        "应用层能力"
      ],
      "source": "中华人民共和国专利法.txt：第二条、第二十二条、第二十三条"
    },
    {
      "block_id": "decision_flow-1",
      "block_type": "decision_flow",
      "title": "材料成果的客体判断流程",
      "payload": {
        "question": "材料研发成果应如何初步确定对应的专利保护客体？",
        "steps": [
          {
            "condition": "成果的核心是对产品、方法或者其改进提出新的技术方案",
            "outcome": "进入发明的分类方向；其后需关注第二十二条规定的新颖性、创造性和实用性。"
          },
          {
            "condition": "成果的核心是对产品形状、构造或者其结合提出适于实用的新的技术方案",
            "outcome": "进入实用新型的分类方向；其后需关注第二十二条规定的新颖性、创造性和实用性。"
          },
          {
            "condition": "成果的核心是产品整体或者局部的形状、图案及其结合，或者色彩与形状、图案的结合形成的新设计",
            "outcome": "进入外观设计的分类方向；其后适用第二十三条的授权条件。"
          },
          {
            "condition": "仅能说明材料名称、应用场景或商业价值，不能说明成果究竟是技术方案、产品构造还是视觉设计",
            "outcome": "分类事实不足，应补充成果的技术内容和表现对象后再判断。"
          }
        ],
        "end_states": [
          "属于发明方向，后续适用发明的授权条件审查",
          "属于实用新型方向，后续适用实用新型的授权条件审查",
          "属于外观设计方向，后续适用外观设计的授权条件审查",
          "不应仅因材料名称或应用行业而确定专利类型，应回到成果的法定定义核对"
        ]
      },
      "chosen_by": "[A]",
      "trigger": "input=visual(0.73)",
      "rationale": "将第二条的客体定义转换为可按事实逐步执行的分类流程。",
      "adapts_to": [
        "视觉型输入偏好"
      ],
      "source": "中华人民共和国专利法.txt：第二条、第二十二条、第二十三条"
    },
    {
      ...
      "title": "客体分类与三性记忆表",
      "payload": {
        "device": "分类顺序表：“技—构—设；发实看三性”。先看成果是技术方案、产品构造还是产品设计；属于发明或实用新型后，再核对新颖性、创造性、实用性。",
        "mapping": [
          {
            "term": "技",
            "explanation": "对产品、方法或者其改进提出的新的技术方案，对应发明的法定定义。"
          },
          {
            "term": "构",
            "explanation": "对产品形状、构造或者其结合提出的适于实用的新的技术方案，对应实用新型的法定定义。"
          },
          {
            "term": "设",
            "explanation": "对产品整体或者局部的形状、图案及其结合，以及色彩与形状、图案结合形成的新设计，对应外观设计的法定定义。"
          },
          {
            "term": "三性",
            "explanation": "发明和实用新型均应具备新颖性、创造性和实用性。"
          }
        ],
        "when_recall": "阅读材料研发记录、准备立项检索或判断申请类型时，按“技—构—设；发实看三性”的顺序核对。"
      },
      "chosen_by": "[A]",
      "trigger": "understanding=sequential(0.70)",
      "rationale": "以分类表固定客体判断与三性审查的先后关系。",
      "adapts_to": [
        "顺序型理解偏好"
      ],
      "source": "中华人民共和国专利法.txt：第二条、第二十二条"
    ...
    {
      "block_id": "predict_activate-1",
      "block_type": "predict_activate",
      "title": "先作成果类型预测",
      "payload": {
        "prompt": "在查看法条定义前，先将材料配方、制备工艺、隔膜结构和电池外壳纹样分别预判为技术方案、产品构造或产品设计中的哪一类。",
        "activate": "材料研发中对“配方、工艺、产品结构、外壳视觉设计”四类成果表现形式的既有区分。",
        "reveal_hint": "判断关键不在材料属于电池、化工或金属行业，而在成果的法定表达对象：产品或方法的技术方案、产品构造，或者产品视觉设计。"
      },
      "chosen_by": "[A]",
      "trigger": "processing=active(0.62)",
      "rationale": "先激活研发活动中已有的成果分类经验，再以法定定义校正。",
      "adapts_to": [
        "主动加工偏好"
      ],
      "source": "中华人民共和国专利法.txt：第二条"
    },
    {
      ...
      "payload": {
        ...
        "items": [
          {
            "qid": "q-foundation-review-1",
            "summary": "复习发明创造三种法定类型的基本分类。"
          },
          {
            "qid": "q-application-forward-1",
            "summary": "仅探测下一节点中发明或实用新型申请文件的基本构成。"
          },
          {
            "qid": "q-foundation-weakness-1",
            "summary": "辨析材料成果的客体分类与发明、实用新型的三性要求。"
          }
        ],
        "body_guide": "本节设有测评，请到【习题】区作答。隔膜层状结构的易混点是：它符合实用新型定义方向，并不意味着可以跳过第二十二条的三性审查。"
      },
      "chosen_by": "[A]",
      "trigger": "mandatory",
      "rationale": "按编排层范围分别设置本节点复习、本节点辨析和下一节点L1探测。",
      "adapts_to": [],
      "source": "中华人民共和国专利法.txt：第二条、第二十二条、第二十六条"
    },
    {
      "block_id": "knowledge_synthesis-1",
      "block_type": "knowledge_synthesis",
      "title": "专利法律制度基础框架",
      "payload": {
        "framework": [
          "专利权的基本特征可概括为独占性、时间性和地域性；本节点仅作制度定位，不在此展开其具体效力边界。",
          ...
          "审查制度概览：本节点仅建立“申请由国务院专利行政部门统一受理和审查”的法定基础；关于早期公开、延迟审查以及初步审查与实质审查并存的具体制度事实，本轮检索上下文未提供直接依据，应结合法条和审查指南原文核验。"
        ],
        "must_know": [
          "发明创造法定分为发明、实用新型和外观设计，不能仅按技术领域名称分类。",
          "发明和实用新型的授权条件包括新颖性、创造性和实用性，三项缺一不可。",
          "现有技术是申请日以前在国内外为公众所知的技术；该概念是后续新颖性和创造性分析的共同基础。"
        ],
        "key_relations": [
          "先根据第二条识别材料成果属于发明、实用新型还是外观设计，再适用相应授权条件。",
          "发明和实用新型进入第二十二条的三性框架；后续节点再分别展开新颖性、创造性和实用性的具体判断。",
          "专利法提供基本制度依据，实施细则细化程序和申请文件要求，审查指南的具体审查规则须以正式原文核验。"
        ]
      },
      "chosen_by": "[A]",
      "trigger": "mandatory",
      "rationale": "逐条覆盖当前节点给定知识点，并清楚标示检索证据不足的边界。",
      "adapts_to": [],
      "source": "中华人民共和国专利法.txt：第一条、第二条、第三条、第二十二条；中华人民共和国专利法实施细则.txt：第二十条至第二十三条"
    },
    {
      "block_id": "summary_card-1",
      ...
      "payload": {
        "cards": [
          {
            "concept": "专利制度目的",
            "one_liner": "专利法第一条将保护权益、鼓励创造、推动应用和促进科技进步与经济社会发展并列为制度目的。"
          },
          {
            "concept": "三种保护客体",
            "one_liner": "发明看产品或方法的技术方案，实用新型看产品形状构造，外观设计看产品视觉设计。"
          },
          {
            "concept": "审查机关",
          ...
          {
            "concept": "发明与实用新型的三性",
            "one_liner": "新颖性看是否属于现有技术，创造性看相对现有技术的实质性特点和进步，实用性看能否制造或使用并产生积极效果。"
          },
          {
            "concept": "证据边界",
            "one_liner": "关于审查指南具体规范和审查程序细节，应以后续检索到的正式文本核验，不能以本节点概览替代。"
          }
        ],
        "must_recite": [
          "《中华人民共和国专利法》第二条：发明创造包括发明、实用新型和外观设计。",
          "《中华人民共和国专利法》第二十二条：发明和实用新型应当具备新颖性、创造性和实用性。",
          "现有技术是申请日以前在国内外为公众所知的技术。"
        ],
        "one_line": "材料专利审查的基础顺序是：先定保护客体，再按对应法定条件审查。"
      },
      "chosen_by": "[A]",
      "trigger": "len(knowledge_sub_nodes)=3>=3",
      "rationale": "以速查卡收束本节点的分类、制度目的、审查机关和三性入口。",
      "adapts_to": [
        "知识子点数量较多"
      ],
      "source": "中华人民共和国专利法.txt：第一条、第二条、第三条、第二十二条"
