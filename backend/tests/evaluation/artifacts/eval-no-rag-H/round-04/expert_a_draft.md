...
|---:|---|:--:|---|---|:--:|
| 1 | `anchor_scenario` | 自适应 | perception=sensing(0.82) / cold_start | 材料研发成果的专利制度入口｜某材料研发团队开发了三项成果：一种耐高温涂层配方、一种用于批量制备该涂层的设备结构，以及该设… | [A] |
| 2 | `legal_anchor` | 必选 | mandatory | 保护客体的法条锚点｜《中华人民共和国专利法》第二条 | [A] |
| 3 | `worked_example` | 自适应 | cold_start(low_confidence) | 材料成果的客体识别演示｜某团队形成三份研发资料：耐高温涂层配方及制备工艺、实现该工艺的涂布设备内部结构图、设备外壳的… | [A] |
| 4 | `decision_flow` | 自适应 | input=visual(0.79) | 材料成果进入专利制度的判断流程｜面对一项材料研发成果，如何完成专利制度基础层面的初步识别？ | [A] |
| 5 | `reflect_prompt` | 自适应 | processing=reflective(0.63) | 从研发资料回看制度分类｜回看一项你熟悉的材料研发项目：其中哪些资料是在说明技术方案，哪些资料是在呈现产品外观，哪些资… | [A] |
| 6 | `assessment` | 必选 | mandatory | 本节三类测评｜复习专利法第二条列举的三类保护客体。 | [A] |
| 7 | `knowledge_synthesis` | 必选 | mandatory | 专利法律制度基础框架｜专利制度基本特征：专利权具有独占性、时间性和地域性；这三项特征用于理解权利保护的基本边界。 | [A] |
| 8 | `summary_card` | 自适应 | len(knowledge_sub_nodes)=3>=3 | 专利制度基础速查卡｜先识别保护客体和规则体系，再进入材料技术方案的申请、审查与授权条件分析。 | [A] |
...
> 某材料研发团队开发了三项成果：一种耐高温涂层配方、一种用于批量制备该涂层的设备结构，以及该设备的外观方案。团队准备在中国申请专利，但成员把三项成果都称为“材料专利”，并认为只要技术先进就可以用同一种方式保护。

代理人首先需要解决的不是新颖性或创造性结论，而是识别每项成果属于何种专利保护客体，以及后续审查制度将依据哪些规范文件展开。只有先建立这一制度地图，才能在后续材料技术检索中正确进入新颖性和创造性判断。

**锚定**：该情境锚定专利保护客体、制度规范层级和审查路径的基础框架。

**先想一想**：面对配方、设备结构和设备外观三项成果，应先按什么标准区分其可能对应的专利类型？

### 保护客体的法条锚点（legal_anchor）

- **《中华人民共和国专利法》第二条**：专利法将保护客体区分为发明、实用新型和外观设计；材料研发成果进入专利审查前，应先识别其技术内容或外观设计内容对应的客体。

**为何重要**：材料领域的配方、制备方法、设备结构和产品外观可能落入不同保护客体。正确识别客体是理解后续申请、审查及新颖性、创造性判断适用对象的前提。

### 材料成果的客体识别演示（worked_example）

**案情/例题**：某团队形成三份研发资料：耐高温涂层配方及制备工艺、实现该工艺的涂布设备内部结构图、设备外壳的视觉造型图。团队拟以“一项材料专利”统一处理。应如何先完成专利制度基础层面的客体识别？
**适用规则**：《中华人民共和国专利法》第二条；教学上下文明确列举发明、实用新型、外观设计三种专利保护客体。
**分步推演**：
1. 先将每份资料按其表达的成果内容拆分：配方和工艺指向技术方案，内部结构图指向产品的技术结构，外壳造型图指向产品外观。不能因成果均服务于材料生产而省略拆分。 → *先按成果内容拆分，不按项目名称归类。*
2. 教学上下文列明专利保护客体包括发明、实用新型和外观设计。对配方、方法及具有技术结构的设备，应从技术方案所对应的客体进行识别；对视觉造型资料，则从外观设计客体进行识别。 → *以法定三类客体作为分类框架。*
3. 客体识别仅解决“进入何种专利制度轨道”的初步问题，不能替代后续申请文件、审查程序及授权条件的判断。 → *客体分类不等于已经获得授权。*
**结论**：耐高温涂层配方及其制备方法应优先从发明客体方向识别；设备的技术结构与设备的外观方案不能当然视为同一保护客体，需分别按照其技术内容或外观设计内容进一步判断。
**本题要点**：材料专利实务的第一步是把研发成果拆成可分别识别的保护客体，再进入后续审查判断。
...
flowchart TD
  ...
  S1{"成果资料主要描述产品、方法或其改进所涉及的技术内容"}
  START -->|进入技术方案的客体识别路径，并根据成果具体性质进一步区分。| S1
  S2{"成果资料主要描述产品外观的视觉设计内容"}
  S1 -->|进入外观设计客体识别路径。| S2
  S3{"资料同时混合配方、结构、工艺或外观内容"}
  S2 -->|先拆分为相对独立的成果单元，分别识别，避免以一个项目名称替代法律分类。| S3
  S4{"已完成客体初步识别"}
  S3 -->|再衔接申请文件、审查程序和后续授权条件的分析；本节不预先作出新颖性或创造性结论。| S4
  E1(["形成发明、实用新型或外观设计方向的初步识别"])
  S4 --> E1
  E2(["材料尚不足以完成客体识别，需先补充技术或外观事实"])
  S4 --> E2
  E3(["完成基础识别后进入对应的申请与审查阶段"])
  S4 --> E3
```

### 从研发资料回看制度分类（reflect_prompt）

**反思问题**：回看一项你熟悉的材料研发项目：其中哪些资料是在说明技术方案，哪些资料是在呈现产品外观，哪些资料不足以单独完成专利客体识别？

**关注要点**：项目名称或商业名称不能替代对成果内容的法律识别。；同一研发项目可能包含多个应分别识别的成果单元。；客体识别是后续申请、审查与授权条件分析的起点，而非授权结论。

**连接**：连接到学习者已有的材料研发经验：实验记录、工艺路线、设备图纸和产品设计资料通常具有不同的技术与法律表达功能。
...
**概念关系**：先识别成果是否及如何落入三种保护客体，再衔接对应申请文件与审查程序。；专利法、实施细则和审查指南共同构成理解审查规则的规范入口，但本节仅建立体系定位。；独占性、时间性和地域性解释权利边界；制度功能解释为何以公开换取有限期间保护。
**必记**：《中华人民共和国专利法》第二条所列三种保护客体为发明、实用新型和外观设计。；材料研发项目不能因属于同一项目而当然只对应一种保护客体，应依据具体成果内容作初步识别。；本节只建立制度基础；新颖性和创造性的具体判定规则须在后续对应节点基于直接依据学习。

### 专利制度基础速查卡（summary_card）

**要点卡**：
- **独占性、时间性、地域性**：专利权的基本特征说明其保护不是无限、永久或全球自动生效。
- **规范体系**：专利法、专利法实施细则和专利审查指南共同构成理解中国专利审查规则的制度入口。
- **三种保护客体**：发明、实用新型和外观设计是专利法第二条明确列举的三类客体。
- **制度功能**：专利制度以有限保护与技术公开相结合，服务于激励创新和促进技术应用。
- **审查制度背景**：早期公开延迟审查及初步审查与实质审查并存，是理解后续程序节点的背景。
**必背**：《中华人民共和国专利法》第二条列举的三种保护客体：发明、实用新型、外观设计。；材料项目应按具体成果内容进行客体识别，不能仅按项目名称归类。；本节建立制度地图，不替代后续关于新颖性和创造性的具体审查判断。
**一句话总结**：先识别保护客体和规则体系，再进入材料技术方案的申请、审查与授权条件分析。

### 本节三类测评（assessment）

**三类覆盖**：backward_review、forward_probe、weakness_probe
**题目**：
- q-foundation-review-l1：复习专利法第二条列举的三类保护客体。
- q-application-probe-l1：探测下一节点中申请文件的基础构成。
- q-foundation-weakness-l3：辨析同一材料项目中技术内容与外观内容的分类边界。
