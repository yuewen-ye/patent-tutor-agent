...
[
  ...
  },
  {
    ...
    "kc_node_id": "patent-law-foundation",
    "question": "某企业拟就生产线节拍优化方案、可折叠设备支架和包装箱图案寻求专利保护；其后又发现竞争者销售了类似支架。下列关于分析顺序的表述，哪一项最准确？",
    "answer": "D",
    "options": [
      "A. 生产线节拍优化的软件控制逻辑、可折叠设备支架和包装箱图案均应先按同一种专利客体处理，再统一判断是否侵权",
      "B. 可折叠设备支架已在企业内部试制，因此无需识别其是否属于产品形状、构造或者其结合的技术方案，直接以研发完成时间判断能否授权",
      "C. 包装箱图案属于外观设计方向，因此生产线节拍优化的软件控制逻辑和可折叠设备支架均不再需要分别判断其法定保护客体",
      "D. 应先分别识别生产线节拍优化方案、可折叠设备支架和包装箱图案的成果表现形式；如争点是发明或实用新型能否授权，再进入三性分析；如争点是他人实施是否违法，则进入后续保护范围分析"
    ]
  }
]
```
...
```json
{
  ...
  "learner_id": "ea8b49d586ef4ff5ab5c37869dd20407",
  "blocks": [
    {
      "block_id": "anchor_scenario_1",
      "block_type": "anchor_scenario",
      "title": "智能工厂研发成果的第一道分类门",
      "payload": {
        "scenario": "某智能制造企业的研发团队在一条电机装配线上完成三项改进：算法工程师开发了依据振动数据自动调整维护周期的方法；机械工程师设计了可快速拆装的机器人夹具；工业设计师重做了控制柜局部面板的视觉布局。企业准备申请专利，同时担心竞争者已在展会上展示过类似设备，并计划对后续出现的仿制品维权。\n\n法务人员不能直接回答“是否新颖”或“是否侵权”，而要先辨认三项成果分别是什么类型的发明创造，再确定应当进入授权条件、审查程序还是权利保护范围的分析路径。",
        "why_anchor": "该情境锚定“先识别保护客体，再分流至授权或侵权问题”的专利制度基础框架。",
        "think_prompt": "面对同一条智能产线上的方法、结构和视觉设计，为什么不能用同一套规则直接判断它们能否申请和是否侵权？"
      },
      "chosen_by": "[A]",
      "trigger": "perception=sensing(0.78) / cold_start",
      "rationale": "以具体研发成果建立三类专利客体与不同法律路径的初步区分。",
      "adapts_to": [
        "具体情境偏好",
        "感知型学习偏好",
        "冷启动"
    ...
    },
    {
      ...
      "payload": {
        ...
        "plain_summary": [
          "第二条先把可受专利法保护的发明创造分为发明、实用新型、外观设计，并分别限定其法定定义。",
          "第二十二条规定发明和实用新型的授权条件包括新颖性、创造性和实用性；其中现有技术以申请日前公众已知的技术为界。"
        ],
        "why_it_matters": "本节点是后续新颖性和侵权学习的共同入口。先根据第二条确定成果类别，才能在正确的法律路径中适用后续授权规则或权利保护规则。"
      },
      "chosen_by": "[A]",
      "trigger": "mandatory",
      "rationale": "以可核验法条固定本节点的客体分类和三性入口。",
      "adapts_to": [
        "法条优先",
        "初学者"
      ],
    ...
    },
    {
      ...
      "title": "示范：为智能制造成果选择正确分析入口",
      "payload": {
        "problem": "某制造企业形成三项研发成果：甲为根据设备振动数据自动调整维护周期的方法；乙为用于固定协作机器人的快拆夹具结构；丙为控制柜局部面板的图案与形状设计。企业询问：三项成果是否应以同一类型申请专利，并能否直接据此判断日后相似产品构成侵权？",
        "applicable_rule": "《中华人民共和国专利法》第二条；涉及发明和实用新型授权条件时，进入《中华人民共和国专利法》第二十二条。",
        "steps": [
          {
            "reasoning": "先对甲成果识别技术表现形式。甲的核心是依据数据调整维护周期的技术方法，符合第二条中“对产品、方法或者其改进所提出的新的技术方案”这一发明定义方向。",
            "summary": "甲优先沿发明的技术方法路径分析。"
          },
          {
            "reasoning": "再对乙成果识别技术表现形式。乙的核心是夹具的产品结构，属于第二条中“对产品的形状、构造或者其结合所提出的适于实用的新的技术方案”的实用新型定义方向。",
            "summary": "乙优先沿实用新型的产品结构路径分析。"
          },
          {
            "reasoning": "最后对丙成果识别技术表现形式。丙关注控制柜局部面板的形状、图案等视觉设计，应优先沿第二条外观设计定义方向分析。",
            "summary": "丙优先沿外观设计的产品视觉设计路径分析。"
          },
          {
            "reasoning": "客体分类后，不应把授权与侵权混作一步。甲、乙若进入授权条件分析，应进一步考察第二十二条的三性；日后是否侵权，则须在后续节点从有效权利和保护范围出发比较被诉技术方案。",
            "summary": "分类决定后续规则入口，技术相似不等于当然侵权。"
          }
        ],
        "conclusion": "三项成果不应以同一类型机械处理：方法、产品结构和产品视觉设计分别对应不同的法定客体分析方向；新颖性属于授权条件，侵权属于后续权利保护范围判断。",
        "takeaway": "训练“先分客体、再分问题、后套具体规则”的线性分析能力。"
      },
      "chosen_by": "[A]",
      "trigger": "cognition.analyze=0.29<0.3 / cold_start",
      "rationale": "通过分步演示降低从技术事实跳转至法律分类的难度。",
      "adapts_to": [
        "分析能力待提升",
        "应用能力待提升",
        "冷启动"
    ...
    },
    {
      ...
      "title": "专利问题的基础分流流程",
      "payload": {
        "question": "面对一项智能制造研发成果，如何确定应从哪一条专利法律分析路径进入？",
        "steps": [
          {
            "condition": "成果核心是产品、方法或者其改进所提出的技术方案",
            "outcome": "优先识别为发明方向；如讨论授权条件，再进入发明的三性分析。"
          },
          {
            "condition": "成果核心是产品形状、构造或者其结合提出的适于实用的技术方案",
            "outcome": "优先识别为实用新型方向；如讨论授权条件，再进入实用新型的三性分析。"
          },
          {
            "condition": "成果核心是产品整体或局部的形状、图案及其结合等视觉设计，并适于工业应用",
            "outcome": "优先识别为外观设计方向，避免套用发明或实用新型的定义。"
          },
          {
            "condition": "争点是申请日前技术是否已公开、能否取得授权",
            "outcome": "进入后续授权条件和新颖性分析，不直接作侵权判断。"
          },
          {
            "condition": "争点是竞争者实施的技术或产品是否落入专利保护范围",
            "outcome": "进入后续权利要求解释与侵权分析，不以技术相似替代保护范围比对。"
          }
        ],
        "end_states": [
          "确定为发明方向并进入相应授权条件分析",
          "确定为实用新型方向并进入相应授权条件分析",
          "确定为外观设计方向并进入相应授权条件分析",
          "确定为授权条件争点，后续学习新颖性等规则",
          "确定为侵权争点，后续学习保护范围与侵权类型"
        ]
      },
      "chosen_by": "[A]",
      "trigger": "input=visual(0.74)",
      "rationale": "将客体识别与争点分流转化为可执行的线性流程。",
      "adapts_to": [
        "视觉型学习偏好",
        "顺序型学习偏好"
      ],
    ...
    },
    {
      ...
      "title": "分类与分流记忆表",
      "payload": {
        "device": "“三客体、两问题、一步序”记忆表：发—方法或技术方案；实—产品结构；外—产品视觉设计；授—授权条件；权—权利保护；先分类，后分流。",
        "mapping": [
          {
            "term": "发",
            "explanation": "发明：对产品、方法或者其改进所提出的新的技术方案。"
          },
          {
            "term": "实",
            "explanation": "实用新型：对产品的形状、构造或者其结合所提出的适于实用的新的技术方案。"
          },
          {
            "term": "外",
            "explanation": "外观设计：对产品整体或局部的形状、图案等作出的富有美感并适于工业应用的新设计。"
          },
          {
            "term": "授",
            "explanation": "涉及能否获得专利权时，发明和实用新型进入新颖性、创造性、实用性等授权条件分析。"
          },
          {
            "term": "权",
            "explanation": "涉及他人实施是否违法时，进入后续有效权利和保护范围的侵权分析。"
          },
          {
            "term": "先分类，后分流",
            "explanation": "先判保护客体，再区分授权问题与侵权问题，避免直接跳到结论。"
          }
        ],
        "when_recall": "看到智能制造项目同时包含算法、设备结构和界面设计，或者看到“能否申请”“是否侵权”两类提问时，先使用该表定位分析入口。"
      },
      "chosen_by": "[A]",
      "trigger": "understanding=sequential(0.67)",
      "rationale": "用分类表固定客体识别和争点分流的先后顺序。",
      "adapts_to": [
        "顺序型学习偏好",
        "概念混淆风险"
      ],
    ...
    },
    {
      ...
      "title": "从研发经验回看专利制度入口",
      "payload": {
        "question": "回顾你熟悉的一项智能制造研发成果：其中哪些部分是技术方法、哪些是产品结构、哪些是产品视觉设计？如果出现竞争对手的类似方案，你会先收集哪一类事实以决定它属于授权问题还是侵权问题？",
        "what_to_notice": [
          "不要把研发完成时间直接当作专利授权或侵权结论。",
          "先分清成果的技术表现形式，再识别争点是授权条件还是权利保护。",
          "涉及申请日前公开的事实时，后续应进入新颖性规则；涉及竞争者实施时，后续应进入保护范围规则。"
        ],
        "connect": "连接到学习者已有的理工研发经验：把技术模块拆分为方法、结构和视觉设计，再把法律问题拆分为授权与保护两类。"
      },
      "chosen_by": "[A]",
      "trigger": "processing=reflective(0.61)",
      "rationale": "引导将抽象分类框架映射至既有研发项目。",
      "adapts_to": [
        "反思型学习偏好",
        "真实项目迁移"
      ],
    ...
    },
    {
      ...
      "payload": {
        ...
        "items": [
          {
            "qid": "q_foundation_backward_l1",
            "summary": "复习三类专利客体中实用新型的法定定义方向。"
          },
          {
            "qid": "q_overview_forward_l1",
            "summary": "仅探测下一节点的专利制度核心运行机制。"
          },
          {
            "qid": "q_foundation_weakness_l3",
            "summary": "迁移辨析不同智能制造成果的客体分类、授权争点与侵权争点分流。"
          }
        ],
      ...
      "chosen_by": "[A]",
      "trigger": "mandatory",
      "rationale": "按照既定范围覆盖向后复习、向前探测与薄弱点挑战。",
      "adapts_to": [
        "掌握度核验",
        "概念混淆识别"
      ],
    ...
    },
    {
      ...
      "payload": {
        ...
        "must_know": [
          "先依据《专利法》第二条识别发明、实用新型或外观设计，不能把不同客体混为一类。",
          "新颖性是发明和实用新型的授权条件问题，侵权是有效专利权保护范围问题；两者的判断入口不同。",
          "发明和实用新型的三性法条入口是《专利法》第二十二条。"
        ],
        "key_relations": [
          "客体分类在前：先判断技术成果属于方法、产品结构还是产品视觉设计。",
          "争点分流在后：申请授权问题进入三性等授权条件；实施争议问题进入保护范围和侵权分析。",
          "时间维度贯穿授权：第二十二条将现有技术界定为申请日以前在国内外为公众所知的技术。",
          "程序特点服务制度运行：检索资料所载发明实质审查与其他两类初步审查的差异，需在后续审查节点展开。"
        ]
      },
      "chosen_by": "[A]",
      "trigger": "mandatory",
      "rationale": "覆盖当前节点全部五项细粒度知识点并呈现其依赖关系。",
      "adapts_to": [
        "框架化学习",
        "概念混淆防范"
      ],
      "source": "中华人民共和国专利法.txt：第二条、第二十二条；专利法律知识详细解读.txt"
    },
    {
      ...
      "payload": {
        "cards": [
          {
            "concept": "三种保护客体",
            "one_liner": "发明看产品、方法或改进的技术方案；实用新型看产品结构；外观设计看产品视觉设计。"
          },
          {
            "concept": "两类法律问题",
            "one_liner": "新颖性等问题属于授权条件路径；是否仿制违法属于后续侵权保护路径。"
          },
          {
            "concept": "三项制度特征",
            "one_liner": "独占性、时间性、地域性是观察专利权法律效果的基本维度。"
          },
          {
            "concept": "制度功能",
            "one_liner": "鼓励发明创造并推动其应用，进而促进技术进步和经济社会发展。"
          },
          {
            "concept": "审查特点",
            "one_liner": "检索资料记载发明经过初步审查和实质审查，实用新型与外观设计采用初步审查路径。"
          }
        ],
        "must_recite": [
          "《专利法》第二条：发明创造包括发明、实用新型和外观设计。",
          "《专利法》第二十二条：发明和实用新型应具备新颖性、创造性和实用性。",
          "先分类，再分流：先识别保护客体，再区分授权条件问题与侵权问题。"
        ],
        "one_line": "智能制造专利分析的起点是：先按法定客体分类，再按授权或保护争点分流。"
      },
      "chosen_by": "[A]",
      "trigger": "len(knowledge_sub_nodes)=3>=3",
      "rationale": "以速查卡收束五项知识点，便于后续进入新颖性和侵权节点时复盘。",
      "adapts_to": [
        "视觉型学习偏好",
        "多子知识点复盘"
      ],
