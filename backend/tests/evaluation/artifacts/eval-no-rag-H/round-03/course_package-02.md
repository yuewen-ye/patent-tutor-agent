...
中国专利制度的基础规范体系包括专利法、专利法实施细则和专利审查指南。专利法提供基本制度和法定分类，实施细则与审查指南在申请和审查实践中对具体问题进行细化。由于本次检索上下文为空，本节不补充未经核验的具体条文原文、审查指南规则或案例。
...
现在请回顾一个你熟悉或真实参与过的材料研发项目，不要只看项目名称，而要回到研发资料本身：从实验方案、配方记录、工艺参数和操作步骤中找出方法事实；从装置结构图、部件连接关系、尺寸或构造改进资料中找出产品结构事实；从样机照片、外观设计图以及形状、图案、色彩资料中找出产品外观事实。请分别写下三类资料对应的事实，不确定的部分标记为“待核对”，不要用“性能更好”或“项目创新”替代具体事实。

完成拆分后，再说明申请准备顺序将如何变化：先按方法、产品结构和产品外观分别识别可能的保护客体，再分别核对相应申请资料和法律条件，之后才进入申请程序准备以及新颖性、创造性等实体问题的具体判断。反思时特别注意三点：研发成果名称不等于专利法上的保护客体；同一项目可以包含多个需要分别识别的成果；客体分类先于申请程序和后续实体审查。这样做的目的不是立即判断哪项成果能够授权，而是把已有研发经验准确转换为可供专利分析的法律事实。
