...
REQUIRED_FOREIGN_KEYS = {
    ...
    "fk_diagnostic_attempts_session",
    "fk_diagnostic_attempts_student",
    "fk_diagnostic_mastery_attempt",
    "fk_diagnostic_mastery_student",
    "fk_diagnostic_sessions_student",
    "fk_feedback_profile",
    "fk_feedback_session",
    "fk_feedback_student",
