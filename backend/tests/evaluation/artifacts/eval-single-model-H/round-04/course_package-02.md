...
本节点将中国专利制度发展历程与制度运行特点作为理解后续审查节奏的背景性学习线索，包括早期公开、延迟审查以及不同审查环节的关系；但当前检索上下文未提供这些事项的直接法条、实施细则或审查指南原文，故本节不将其表述为已核验的具体历史事实或程序结论。〔RAG: 检索上下文 — 未提供关于早期公开、延迟审查及初步审查与实质审查具体制度运行的直接依据〕具体规则应在后续申请程序节点依据正式法条、实施细则和审查指南核验。
...
**为何重要**：第二条解决“成果属于哪类专利对象”，第二十二条解决“发明和实用新型还要满足哪些授权条件”。制度运行特点只能在取得正式法条、实施细则或审查指南依据后作具体判断。
...
- 制度运行特点：本节点仅将其作为理解后续学习的背景线索；关于早期公开、延迟审查及不同审查环节的具体事实，须以正式依据另行核验。
...
**必记**：专利权不是永久、全球且无限范围的权利，而是具有独占性、时间性和地域性。；专利法第二条是三类专利保护客体的分类依据，第二十二条是发明和实用新型三性要求的法定入口。；专利法、实施细则和专利审查指南共同构成学习中国专利审查规则的主要制度框架。；材料领域后续判断新颖性和创造性时，应先识别申请日、优先权日、公开时间以及对比文件的法律性质；具体申请程序规则尚未在本节展开。
...
[
  ...
  {
    "article": "检索上下文未提供关于中国专利制度发展历程、早期公开、延迟审查及初步审查与实质审查具体制度运行的直接法条或实施细则原文；本节对此仅作为待后续核验的制度学习线索，不作已核验的具体历史或程序结论。",
    "source": null
  }
]
```
...
[
  ...
  {
    "risk": "对中国专利制度发展历程、早期公开、延迟审查及审查环节特点作出具体断言前，未以正式法条、实施细则或审查指南核验。",
    "related_node_id": "patent-law-foundation"
  }
]
```
...
```json
{
  ...
  "rule": "《专利法》第二条规定发明、实用新型和外观设计的法定定义；第二十二条规定发明和实用新型应具备新颖性、创造性和实用性，并界定现有技术。相关材料明确，新颖性采用单独对比，创造性针对权利要求限定的技术方案整体评价，申请在先、公开在后的中国专利文件只能单独用于新颖性评价。",
  "application": "复合涂层的组成、结构和制备方法应先按产品、方法或其改进的技术方案进行客体定位；产品表面的图案、色彩及其组合则进入外观设计客体分析。客体定位完成后，发明和实用新型仍须接受新颖性、创造性和实用性审查。后续比较文献时，应先按申请日、优先权日和公开时间分类，再决定其证据用途。",
...
```json
{
  ...
  "confusable_pairs": [
    ...
    {
      "pair": "制度运行特点的背景性线索与已核验的具体程序或历史事实不同；缺少直接依据时不得将前者表述为后者。"
    }
  ]
}
```
