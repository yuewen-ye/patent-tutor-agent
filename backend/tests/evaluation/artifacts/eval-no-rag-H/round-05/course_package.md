...
| 2 | `legal_anchor` | 必选 | mandatory | 专利客体的法条锚定｜《中华人民共和国专利法》第二条 | [A+B融合] |
...
《中华人民共和国专利法》第二条所涉及的专利保护客体包括发明、实用新型和外观设计。〔检索上下文未提供直接依据：本轮未提供该条法条原文，以上条号和客体范围依据用户提供的教学上下文，正式使用时应核验现行文本〕

在材料领域，配方、材料组成、制备方法和产品结构，通常首先表现为技术方案问题；产品的形状、图案或色彩等外观特征，则需要从外观设计的角度另行分析。这里的“通常”只是识别方向，不是仅凭技术名称就能作出的最终分类。最终仍应结合申请文件所主张的具体内容以及现行法律、实施细则和审查指南判断。
...
理解中国专利申请和审查规则时，应按规范层次查找依据：专利法提供基本制度和法律规则，专利法实施细则对实施层面的事项作进一步规定，专利审查指南则提供审查实践中的操作性说明。本轮检索上下文未提供这些文件的原文，因此具体条文、期限和审查步骤不能作为已经核验的结论补写。
...
- **《中华人民共和国专利法》第二条**：用户提供的教学上下文将本条与发明、实用新型和外观设计三类专利保护客体相联系；正式引用时仍应核对现行法条原文和适用边界。
...
**适用规则**：用户提供的教学上下文明确列示《专利法》第二条涉及发明、实用新型和外观设计三类保护客体，并列示专利权具有独占性、时间性和地域性。本轮检索上下文未提供完整法条原文，因此不对具体授权期限、地域范围和审查程序作未经核验的条文断言。
**分步推演**：
...
- 专利保护客体：用户提供的教学上下文明确列示发明、实用新型和外观设计三类客体，材料领域分类仍需结合具体拟保护内容和现行规范判断。
...
**必背**：三类保护客体是发明、实用新型和外观设计。；独占性、时间性和地域性必须分别判断。；先识别保护对象，再定位规范层级，最后进入具体申请和授权审查。；本轮检索上下文未提供法条原文，具体条文、期限和审查细节须核验现行文本。
...
[
  {
    ...
    "source": "用户提供的教学上下文；本轮检索上下文未提供法条原文，具体措辞须核验现行文本"
  }
]
```
...
```json
{
  ...
  "rule": "用户提供的教学上下文明确列示《中华人民共和国专利法》第二条涉及发明、实用新型和外观设计三类专利保护客体；同时列示专利制度的基本特征包括独占性、时间性和地域性，并列示专利法、专利法实施细则和专利审查指南构成中国专利制度的重要规范材料。本轮检索上下文未提供相关法条原文，具体措辞、期限和审查细节须核验现行文本。",
  ...
  "conclusion": "本节点的稳定分析顺序是先识别保护客体，再定位规范层级并区分专利权的三个基本属性，最后进入具体申请和授权审查；本轮检索上下文不足以支持未经核验的具体条文、期限或审查细节。"
}
```
...
[
  {
    ...
    "question": "下列哪一组完整列出了本节所依据教学上下文明确列示的三类专利保护客体？",
    "answer": "A",
    "options": [
      "A. 发明、实用新型、外观设计",
      "B. 技术秘密、商标、外观设计",
