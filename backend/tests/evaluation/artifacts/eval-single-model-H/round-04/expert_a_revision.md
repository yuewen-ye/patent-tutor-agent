...
《专利法》第二十二条规定，授予专利权的发明和实用新型应当具备新颖性、创造性和实用性；其中，新颖性要求不属于现有技术且不存在法定的申请在先、公开在后情形，创造性则以与现有技术相比的法定标准判断。〔RAG: 中华人民共和国专利法.txt — 第二十二条：授予发明和实用新型专利权，应当具备新颖性、创造性和实用性〕
...
```json
{
  ...
  "learner_id": "4056a09b000d4fb580d71cddd03a575c",
  "blocks": [
    {
      "block_id": "bf1",
      ...
      "title": "专利制度的全局位置",
      "payload": {
        "position": "本节点是专利法律制度学习的起点；无前置节点，向后衔接申请程序、授权实质条件以及新颖性、创造性判断。",
        "big_picture": "本节点位于专利学习主线的起点：先确认专利制度保护什么、依据什么规范运行、为何要求公开与授权，再进入申请程序和发明、实用新型的实质授权条件。材料研发中的配方、结构、制备方法或器件改进，只有先放入正确的制度框架，后续才可严谨讨论新颖性、创造性及申请策略。",
        "prereq": [
          "无需前置专利法节点；可运用已有材料研发中“技术方案、效果、公开”的基本经验。"
        ],
        "leads_to": [
      ...
      "rationale": "先建立制度坐标，避免把材料研发结论直接等同于可授权结论。",
      "adapts_to": [
        "整体理解偏好",
        "材料技术研发经验"
      ],
    ...
    },
    {
      ...
      "title": "材料研发成果如何进入专利制度",
      "payload": {
        "scenario": "某材料团队制得一种用于锂离子电池正极的复合涂层：涂层包含特定无机颗粒和聚合物粘结体系，并声称可改善循环稳定性。团队计划同时保护涂层材料、制备工艺以及电池产品的外观方案。研发负责人认为“技术先进就应当都能申请专利”，但代理人首先要求区分：各项成果是否属于法定专利保护客体，以及后续应依据哪些规范、经过何种审查。\n\n该场景中的材料性能数据说明技术研发价值，却不能替代专利法上的客体识别和授权条件审查；申请与审查中的具体边界问题，还需在后续新颖性专题中依相应规则学习。",
        "why_anchor": "该情境锚定“技术成果不当然等于专利权客体”，并引出三类专利客体与制度规则层级。",
        "think_prompt": "面对涂层材料、制备方法和电池外观三个成果，应当先按照什么法律分类，再讨论是否可能获得专利保护？"
      },
      "chosen_by": "[A]",
      "trigger": "perception=sensing(0.86) / cold_start",
      "rationale": "以材料研发事实连接抽象制度概念，但不越过本节点提前讲授后续三性判断方法。",
      "adapts_to": [
        "具体事实偏好",
        "材料技术案例切入"
      ],
    ...
    },
    {
      ...
      "payload": {
        ...
        "plain_summary": [
          "第二条将可受专利制度保护的成果分为发明、实用新型和外观设计，并分别给出三者的法定定义。",
          "第二十二条规定发明和实用新型获得专利权须具备新颖性、创造性和实用性，并界定现有技术。"
        ],
        "why_it_matters": "材料领域申请首先要把成果放入正确的保护客体类别；对于发明和实用新型，第二十二条是后续学习新颖性、创造性和实用性的法定入口。"
      },
      "chosen_by": "[A]",
      "trigger": "mandatory",
      "rationale": "以可核验条文固定本节点的客体分类和授权条件边界。",
      "adapts_to": [
        "法条优先",
        "低置信度知识状态"
      ],
    ...
    },
    {
      ...
      "title": "复合涂层成果的制度定位",
      "payload": {
        "problem": "某团队提交三组材料成果：第一组为具有特定层状结构的复合涂层材料；第二组为该涂层的烧结制备工艺；第三组为电池壳体表面的图案与颜色组合。现仅需在制度基础层面识别每组成果应进入的法定客体分析路径，并说明为什么不能因材料性能优良而直接认定可授权。",
        ...
        "steps": [
          {
            "reasoning": "先将复合涂层材料和烧结制备工艺分别识别为产品技术方案与方法技术方案；第二条对发明的定义覆盖产品、方法及其改进。",
            "summary": "材料和工艺首先进入发明专利客体分析。"
          },
          {
            "reasoning": "再考察电池壳体表面的图案与颜色组合，其判断重点是产品整体或局部的视觉设计及工业应用，而不是材料电化学性能。",
            "summary": "视觉设计应进入外观设计客体分析。"
          },
          {
            "reasoning": "客体分类只回答成果处于何种专利保护类型；对发明和实用新型，第二十二条另设新颖性、创造性、实用性授权条件。",
            "summary": "客体适格不等于当然授权。"
          }
        ],
        "conclusion": "该复合涂层及其制备工艺可先按“产品、方法或者其改进所提出的技术方案”审视其发明专利客体属性；电池壳体的视觉设计则应按外观设计的法定定义另行判断。仅完成客体分类并不等于已经满足新颖性、创造性和实用性等授权条件。",
        "takeaway": "材料专利分析先做“成果类型识别”，再进入相应的授权条件与审查程序。"
      },
      "chosen_by": "[A]",
      "trigger": "cognition.apply=0.34<0.4 / cognition.analyze=0.28<0.3 / cold_start",
      "rationale": "完整展示从材料事实到法定客体分类、再到授权条件边界的线性推理。",
      "adapts_to": [
        "应用能力较低",
        "材料技术事实"
      ],
    ...
    },
    {
      ...
      "title": "材料成果的初步分类流程",
      "payload": {
        "question": "一项材料研发成果应如何在专利法律制度基础中确定其初步审查路径？",
        "steps": [
          {
            "condition": "成果是对产品、方法或者其改进提出的技术方案，例如材料组成、微观结构控制或制备方法",
            "outcome": "先按《专利法》第二条的发明定义识别，并在后续进入发明授权条件审查。"
          },
          {
            "condition": "成果是对产品的形状、构造或者其结合提出的适于实用的新的技术方案",
            "outcome": "先按《专利法》第二条的实用新型定义识别，并在后续进入实用新型授权条件审查。"
          },
          {
            "condition": "成果是对产品整体或局部的形状、图案及其与色彩结合所作出的富有美感并适于工业应用的新设计",
            "outcome": "先按《专利法》第二条的外观设计定义识别，并适用外观设计的相应授权条件。"
          },
          {
            "condition": "仅因研发成果具有性能优势或市场价值，即主张当然可授权",
            "outcome": "该推论不能成立；仍须依客体规则、申请程序和相应授权条件逐项审查。"
          }
        ],
        "end_states": [
          "进入发明专利客体及后续三性审查路径",
          "进入实用新型专利客体及后续授权条件审查路径",
          "进入外观设计专利客体及相应授权条件审查路径",
          "不因技术价值本身而当然取得专利权，需继续满足适用条件"
        ]
      },
      "chosen_by": "[A]",
      "trigger": "input=visual(0.81)",
      "rationale": "将三类客体及“客体不等于授权”的关系转化为可执行分支。",
      "adapts_to": [
        "视觉偏好",
        "分步判断"
      ],
    ...
    },
    {
      ...
      "title": "从研发成果反观制度分类",
      "payload": {
        "question": "回看自己熟悉的一项材料研发成果：其中哪些内容是在解决技术问题，哪些内容主要呈现为产品视觉设计；这一划分为什么会影响后续适用的专利规则？",
        "what_to_notice": [
          "不要把“实验效果良好”直接替代法定客体判断。",
          "同一研发项目可能包含产品、方法与外观等不同成果，应分别识别。",
          "发明和实用新型的授权条件包括新颖性、创造性和实用性；其具体判断将在后续节点展开。"
        ],
        "connect": "连接学习者已有的材料研发经验：区分材料组成、制备工艺、器件结构和外观呈现分别对应的技术信息。"
      },
      "chosen_by": "[A]",
      "trigger": "processing=reflective(0.69)",
      "rationale": "促使学习者将法定分类框架映射到既有研发对象。",
      "adapts_to": [
        "反思型加工偏好",
        "研发经验迁移"
      ],
    ...
    },
    {
      ...
      "payload": {
        ...
        "items": [
          {
            "qid": "q1",
            "summary": "复习三类专利保护客体的法定分类。"
          },
          {
            "qid": "q2",
            "summary": "探测下一节点中发明专利申请文件的基础要求。"
          },
          {
            "qid": "q3",
            "summary": "辨析材料技术价值、客体分类与授权条件之间的顺序。"
          }
        ],
      ...
      "chosen_by": "[A]",
      "trigger": "mandatory",
      "rationale": "按既定范围分别验证本节点、探测下一节点并挑战制度框架混淆点。",
      "adapts_to": [
        "基础节点掌握验证",
        "下一节点低风险探测",
        "概念边界辨析"
    ...
    },
    {
      ...
      "payload": {
        ...
        "must_know": [
          "技术成果有价值，不等于当然属于可授权的专利客体，更不等于当然具备授权条件。",
          "《专利法》第二条是三类专利客体的分类依据；《专利法》第二十二条是发明和实用新型三性要求的依据。",
          "材料领域讨论新颖性和创造性前，应先明确所保护的是何种技术方案及其申请路径。"
        ],
        "key_relations": [
          "先识别成果属于发明、实用新型或外观设计，再适用该类客体的授权条件与审查规则。",
          "对于发明和实用新型，第二十二条中的新颖性、创造性、实用性是后续实质审查学习的法定入口。",
          "专利法确立基本规则，实施细则与审查指南在法定授权范围内细化申请和审查操作。"
        ]
      },
      "chosen_by": "[A]",
      "trigger": "mandatory",
      "rationale": "逐条覆盖当前节点五项细粒度知识点，并明确检索证据边界。",
      "adapts_to": [
        "整体理解偏好",
        "制度框架建构"
      ],
      "source": "中华人民共和国专利法.txt；检索上下文未提供审查制度历史细节的直接依据"
    },
    {
      "block_id": "bf9",
      ...
      "payload": {
        "cards": [
          {
            "concept": "专利权的基本特征",
            "one_liner": "专利权以法律授予的排他性为核心，并受到期限和地域的边界约束。"
          },
          {
            "concept": "规范体系",
            "one_liner": "专利法定基本规则，实施细则与审查指南细化程序和审查操作。"
          },
          {
            "concept": "三种保护客体",
            "one_liner": "发明、实用新型、外观设计是第二条规定的三类专利保护客体。"
          },
          {
            "concept": "制度作用",
            "one_liner": "专利制度通过激励创造、技术公开和技术应用服务创新发展。"
          },
          {
            "concept": "后续审查入口",
            "one_liner": "发明和实用新型能否授权，后续须依第二十二条审查新颖性、创造性和实用性。"
          }
        ],
        "must_recite": [
          "《专利法》第二条规定发明、实用新型和外观设计三类专利保护客体。",
          "《专利法》第二十二条规定发明和实用新型应具备新颖性、创造性和实用性。",
          "先识别客体，再进入申请程序和相应授权条件审查。"
        ],
        "one_line": "材料专利学习的起点是：按法定客体给研发成果定位，并以规范体系和授权条件建立后续审查坐标。"
      },
      "chosen_by": "[A]",
      "trigger": "len(knowledge_sub_nodes)=3>=3",
      "rationale": "压缩五项知识点，便于在进入申请程序与三性专题前回顾。",
      "adapts_to": [
        "多子知识点复盘",
        "视觉化速查"
      ],
