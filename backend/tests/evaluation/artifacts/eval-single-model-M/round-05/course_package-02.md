...
|---:|---|:--:|---|---|:--:|
| 1 | `anchor_scenario` | 自适应 | perception=sensing(0.79) / cold_start | 从智能制造项目进入专利制度｜【真实案例证据说明】本轮检索上下文仅提供专利制度、专利客体、审查制度及专利权生效和期限的资料… | [A+B融合] |
| 2 | `legal_anchor` | 必选 | mandatory | 专利制度的法条锚点｜《中华人民共和国专利法》第一条 | [A+B融合] |
| 3 | `worked_example` | 自适应 | cold_start(low_confidence) | 拆解智能制造设备的三类成果｜待核对的智能制造设备包含视觉控制方法、输送装置导向结构和设备外壳局部图案。由于检索上下文没有… | [A+B融合] |
...
【真实案例证据说明】本轮检索上下文提供了专利制度、专利客体、审查制度以及专利权生效和期限的资料，但未提供可核验的真实智能制造专利案件名称、案号、专利号或官方裁判文书。因此不能编造具体案件事实，也不把模拟故事冒充真实案例。先以智能制造项目中常见的三类研发成果作为制度入口：视觉数据驱动的抓取轨迹修正方法、相机支架的连接构造，以及操作面板外壳的局部造型。后续取得官方案件来源后，可将真实事实接入同一分析顺序。
...
因此，在上述智能制造研发对象中，抓取轨迹修正的控制方法应先按发明客体方向识别；相机支架的连接构造应先按实用新型客体方向识别；操作面板外壳的局部造型应先按外观设计客体方向识别。这里的“先按某一方向识别”只回答成果属于什么法定客体，不回答其最终是否能被授权，也不提前判断新颖性或侵权。
...
> 【真实案例证据说明】本轮检索上下文仅提供专利制度、专利客体、审查制度及专利权生效和期限的资料，未提供可核验的真实智能制造专利案件名称、案号、专利号或官方裁判文书。因此不能编造具体案件事实。为保持证据边界，先以智能制造企业的控制方法、机械结构和设备外观作为待核对对象，并明确：真实案例需要补充官方裁判文书、国家知识产权局公开信息或专利公报后，才能用于事实教学。

**锚定**：回应学习者对真实智能制造案例的偏好，同时严格遵守检索证据边界；当前仅用可确认的制度基础训练客体识别和程序层次，具体真实案件待有直接来源后再引入。

**先想一想**：面对一项智能制造成果，先把事实拆成控制方法、产品结构和产品外观，再判断其可能对应的法定客体；在没有可核验案件来源时，不要把未经检索确认的故事当作真实案例，也不要提前作出新颖性或侵权结论。
...
### 拆解智能制造设备的三类成果（worked_example）

**案情/例题**：待核对的智能制造设备包含视觉控制方法、输送装置导向结构和设备外壳局部图案。由于检索上下文没有提供具体真实案件来源，本例只演示如何进行基础分类，不添加未经证实的案件名称、案号或裁判结论。
**适用规则**：《中华人民共和国专利法》第二条、第三条、第二十二条；本例仅演示客体识别与制度位置。检索上下文未提供可核验的真实智能制造案件事实，因此不能将下述分析冒充真实案例。
**分步推演**：
...
**结论**：在待核对的智能制造研发项目中，控制方法可先按发明客体方向识别；支架连接构造可先按实用新型客体方向识别；面板外壳的局部外观可先按外观设计客体方向识别。分类或提交申请均不等于已经获得专利权。
**本题要点**：在取得真实案件的官方来源后，再把案件事实接入同一分类流程；当前口诀只能帮助定位客体，不能直接得出新颖性或侵权结论。
...
[
  ...
  {
    "article": "《中华人民共和国专利法》第三十九条、第四十条：发明专利权以及实用新型、外观设计专利权自公告之日起生效。",
...
[
  ...
  {
    "risk": "检索上下文未提供可核验的真实智能制造专利案例，不能将未经官方来源核实的案件名称、案号、专利号或裁判事实写成真实案例。",
    "related_node_id": "patent-system-overview"
  }
]
```
...
```json
{
  ...
  "application": "对智能制造研发项目，应将控制方法、支架连接构造和面板外观分别与第二条定义比对。控制方法可先进入发明客体方向，结构改进可先进入实用新型客体方向，外观新设计可先进入外观设计客体方向。第三条所示统一受理和审查只是行政程序入口；发明和实用新型还须依据第二十二条进入三性分析。专利权在授权公告后生效，其一般期限则自申请日起计算。",
