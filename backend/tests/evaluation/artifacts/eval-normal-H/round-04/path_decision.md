...
- 决策：`keep`
- 决策原因：当前输入只提供了静态知识 DAG 和易混淆对，没有提供学习者画像、BKT 掌握度、当前活动计划或后端候选路线；在缺少候选路线的前提下无法判断 keep 或 replace，因此采用保守的占位输出，维持最小假设下的可执行教学范围。
- 算法：`candidate_route_keep`
- 路线来源：`candidate_route_keep`
- 路线指纹：`cdf9dece9ff9339a7599f0efc20de9656d43fc98e643cefea67fd1eacd2bdd2e`
- 路线是否实质变化：`否`
- 计划版本动作：`复用当前版本`
- 计划 ID：`63544c60d7d04e7ead7f857b7d6ce469`
- 计划版本：2
- 知识图版本：1.0.0
...
- 类型：无
- 触发：缺少后端算法候选路线与动态学情信息，无法验证是否需要替换长期路线。
- 动作：优先补齐候选路线与学情输入后再做路径决策；在本轮教学中先聚焦当前节点的核心定义、边界条件和易混淆点。
