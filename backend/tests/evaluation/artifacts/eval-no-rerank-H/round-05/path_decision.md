...
- 类型：薄弱点跟进
- 触发：若本轮对新颖性、创造性或修改超范围的判断出现错位，说明基础实质条件和程序边界尚未稳定。
- 动作：下一轮优先回看 novelty、inventive-step、amendment-limits，并把题目难度压到 L1-L2 以做纠偏。
