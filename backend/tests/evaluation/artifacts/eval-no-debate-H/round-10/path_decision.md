...
- 决策：`keep`
- 决策原因：当前仅提供静态知识结构与易混淆对，没有学习者画像、BKT、当前活动计划或后端候选路线，无法判断是否应保持或替换候选路线，因此按保守策略返回最小可用规划：保留未知候选路线框架，仅给出通用教学与出题范围控制。
- 算法：`candidate_route_keep`
- 路线来源：`candidate_route_keep`
- 路线指纹：`cdf9dece9ff9339a7599f0efc20de9656d43fc98e643cefea67fd1eacd2bdd2e`
- 路线是否实质变化：`否`
- 计划版本动作：`复用当前版本`
- 计划 ID：`e12f2637f89247979d016c4a32ad28ef`
- 计划版本：2
- 知识图版本：1.0.0
...
- 类型：薄弱点跟进
- 触发：若学习者在三性判断、程序时序或保护范围题上连续失分
- 动作：优先完成当前教学窗口内对核心实质条件与程序主线的覆盖，并在答题表现暴露时再对薄弱点做局部回补
