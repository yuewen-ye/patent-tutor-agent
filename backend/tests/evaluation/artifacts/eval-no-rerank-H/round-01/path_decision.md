...
- 类型：薄弱点跟进
- 触发：若学员在新颖性、抵触申请或优先权判断中出现混淆
- 动作：下一轮优先回到申请日、公开时间轴与优先权条件，再决定是否推进到创造性或申请程序细节
