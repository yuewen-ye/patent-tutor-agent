...
```json
[
  "在专利法基础中，判断新颖性时，若对比文件公开了与申请完全相同的技术方案，但该对比文件申请日早于申请日、公开日晚于申请日，该对比文件属于何种现有技术？请简要说明理由。",
  "你认为'相关法'中与专利实务最紧密的法律规范主要涉及哪些方面？请列举并解释其与专利审查的关联。"
]
```
...
```json
{
  "questions": [
    "本轮练习的难度是否适中？",
    "讲解或题目的表述是否清晰？",
    "您希望下一轮是继续强化基础还是进入新知识点？"
  ],
  "evaluation_signals": [
    "等待学习者反馈"
  ],
  "feeds": "用于调整下一轮教学节奏与内容适配"
}
```
...
```json
{
  ...
  "plan_id": "fa2009e830e54cd7b2d90a79b95c2787",
  "plan_version": 1
}
```
