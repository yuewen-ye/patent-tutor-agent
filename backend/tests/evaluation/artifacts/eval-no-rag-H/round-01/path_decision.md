...
- 类型：进阶
- 触发：当前教学窗口完成三性总览后，学习者若能稳定区分新颖性、创造性与实用性，且不将第25条排除主题误判为技术方案。
- 动作：进入新颖性、创造性三步法与不授予专利权主题的细化辨析，随后衔接申请程序中的文件与审查节点。
