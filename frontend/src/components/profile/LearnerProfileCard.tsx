  ...
  return (
    <Card className="rounded-2xl border border-[#FFE8D0]/60 bg-white/95 shadow-soft overflow-hidden">
      ...
      <CardHeader className="pb-2 pt-5">
        <CardTitle className="text-lg font-semibold flex items-center gap-3 text-[#5C3A26]">
      ...
      <CardContent className="space-y-5 p-5 pt-2">
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0 pt-0.5">
                    <div className="text-sm font-bold text-[#5C3A26] mb-1">
                      {item.label}
                    </div>
        ...
        <div className="rounded-2xl border border-[#FFE8D0]/50 bg-[#FFF7ED]/50 p-5">
          <div className="flex items-center gap-2.5 mb-4">
            ...
            <span className="text-sm font-bold text-[#5C3A26]">薄弱点分析</span>
          </div>
            ...
            <div className="flex flex-wrap gap-2">
              {profile.weak_points.map((point) => (
                <Badge
                  key={point}
                  variant="outline"
                  className="text-xs px-3 py-1.5 bg-white border-[#D9773E]/20 text-[#9A4A1C] hover:bg-[#FFE8D0]/30 transition-colors cursor-default"
                >
                  {point}
                </Badge>
              ))}
