...
你希望结合真实智能制造案例学习新颖性判断和侵权判定。当前检索上下文仅提供法条、审查规则和学习材料，未提供可核验的机器人抓取系统或其他智能制造专利案件的专利号、裁判文书或案件事实；因此，本节不能将未经检索核验的企业新闻或案例称为“真实案例”。本节先用教学拟制的视觉引导机械臂场景建立制度坐标；进入后续新颖性和侵权专题时，将以可核验的公开专利文献或裁判材料为依据开展案例演示。
...
完成本节后，下一学习环节将先深入新颖性判断：围绕申请日、现有技术、抵触申请与单独对比建立判断顺序；随后进入专利权保护与侵权分析：围绕有效专利权、保护范围和具体实施行为建立分析框架。届时应选用具有公开专利文献或裁判材料依据的智能制造案例进行演示，而不以未经核验的企业故事替代证据。

本节设有测评，请到【习题】区作答。

### 智能制造研发的专利分类起点（anchor_scenario）

> 教学拟制场景：协作机器人抓取单元包含视觉引导轨迹控制方法、快换夹具锁止结构和夹具局部外观。研发团队希望同时布局专利，却不确定应如何分类。当前检索上下文未提供可核验的机器人抓取系统真实专利案例材料，因此本场景不是已检索到的真实案件。

**锚定**：同一设备中的方法、结构和外观并置，便于直观看到专利客体不能按行业名称一概而论；后续应以可核验的公开专利文献或裁判材料补充真实案例演示。
...
[
  ...
  {
    "risk": "将未经公开专利文献或裁判材料核验的智能制造企业故事误当作真实专利案例。",
    "related_node_id": "patent-law-foundation"
  }
]
```
