...
```json
[
  "请说明“专利基础”和“专利框架”这两类问题在判断时分别主要看什么，不要只给结论，尽量说出你的判断依据。",
  "如果把一道新题放到一个陌生案例里，你更容易卡在“识别题目考点”还是“把已知规则映射到案例事实”上？"
]
```
...
{
  "questions": [
    "本轮题目的难度与你的预期相比是偏易、适中还是偏难？",
    "题干表述是否足够清晰，还是你更希望看到更明显的边界提示或反例对照？",
    "这种分层题目安排是否帮助你确认自己对基础概念的稳定性？"
  ],
  "evaluation_signals": [
    "三题均判对，且覆盖基础与框架两类技能",
    "历史画像显示在基础与框架层面持续稳定",
  ...
  "feeds": "用于后续判断题目难度是否需要上调、案例边界提示是否需要增强，以及学习者在高掌握状态下是否仍需要更具区分度的迁移题"
}
```
