...
```json
[
  "请用自己的话区分“发明的基本构成”与“专利框架中的适格性判断”，并说明二者各自关注的证据点是什么？",
  "如果把同一技术方案放到“基础判断”和“框架判断”两个场景里，你会优先检查哪一项不同的条件？"
]
```
...
{
  "questions": [
    "本轮问题的难度对你来说是偏易、适中还是偏难？",
    "讲解中的步骤拆分是否足够清晰，能帮助你快速定位答题依据？",
    "如果加入一个真实案例对比，是否会更有助于你理解边界？"
  ],
  "evaluation_signals": [
    "本轮作答均正确，且与历史稳定表现一致",
    "当前未见明显犹豫、情绪波动或节奏跟不上的证据"
  ],
  "feeds": "用于判断节奏是否可以继续提升、是否需要更多案例化表达，以及学习者当前的参与度是否保持稳定"
}
```
