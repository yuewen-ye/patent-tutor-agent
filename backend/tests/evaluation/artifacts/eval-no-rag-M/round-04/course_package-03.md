...
分析时，先拆分控制技术方案、设备机械结构和产品外观；再判断其可能对应的专利客体；随后确定应查阅专利法、专利法实施细则和专利审查指南；最后识别问题处于申请、审查还是授权后的权利保护阶段。
...
独占性是指权利人在法定权利范围内具有排他性利益，但不能据此主张对一切相近技术或一切行为无限控制。时间性是指专利权的效力受法定期限约束，不是永久权利。地域性是指专利权原则上依特定法域的法律和授权范围发生效力，不当然覆盖全球。
...
[
  {
    "question": "练习一：关于中国专利保护客体的表述，哪一项正确？A. 仅包括发明和实用新型；B. 仅包括发明和外观设计；C. 包括发明、实用新型和外观设计；D. 所有研发成果当然属于同一种客体。",
    "answer": "C。答案解析：发明、实用新型和外观设计均为教学上下文列明的专利保护客体。评分规则：单选题，选择C得1分；选择其他选项或多选得0分。",
    "options": [
      "A. 仅包括发明和实用新型",
      "B. 仅包括发明和外观设计",
      "C. 包括发明、实用新型和外观设计",
  ...
  {
    "question": "练习二：仅根据下一节点提供的知识点，关于发明和实用新型专利权保护的一项规则，哪一项正确？A. 未经许可实施任何技术方案均当然侵权；B. 授权后未经许可不得为生产经营目的实施其专利；C. 申请公开后即可排除任何他人使用；D. 外观设计保护范围一律以文字权利要求为准。",
    "answer": "B。答案解析：下一节点教学上下文明确，发明和实用新型专利授权后，未经许可不得为生产经营目的实施其专利。评分规则：单选题，选择B得1分；选择其他选项或多选得0分。",
    "options": [
      "A. 未经许可实施任何技术方案均当然侵权",
      "B. 授权后未经许可不得为生产经营目的实施其专利",
      "C. 申请公开后即可排除任何他人使用",
      "D. 外观设计保护范围一律以文字权利要求为准"
    ]
  },
  {
    "question": "练习三：关于中国专利制度的程序特点，下列哪一项最恰当？A. 早期公开后立即当然取得完整专利权；B. 延迟审查意味着所有申请均不需审查；C. 两类审查制度并存意味着同一申请必须接受完全相同的双重审查；D. 早期公开、延迟审查以及初步审查制与实质审查制并存属于当前节点提示的制度特点。",
    "answer": "D。答案解析：当前节点知识点直接列示早期公开、延迟审查以及初步审查制与实质审查制并存；其余选项分别混淆公开与授权、否定审查，或错误理解两类审查制度。评分规则：单选题，选择D得1分；选择其他选项或多选得0分。",
    "options": [
      "A. 早期公开后立即当然取得完整专利权",
      "B. 延迟审查意味着所有申请均不需审查",
      "C. 两类审查制度并存意味着同一申请必须接受完全相同的双重审查",
      "D. 早期公开、延迟审查以及初步审查制与实质审查制并存属于当前节点提示的制度特点"
    ]
  }
]
```
