...
```json
[
  "请区分“专利法基础规则”和“相关法域规则”在案件判断中的使用顺序。",
  "遇到一个新案件时，你会先抓事实要件还是先找对应法条依据？请说明理由。"
]
```
...
{
  "questions": [
    "本轮的题目节奏对你来说是偏快、合适还是偏慢？",
    "如果下一轮改成案例题，你更需要事实拆解还是法条定位先行？",
    "本轮的表述是否足够清晰，还是需要更明确的争点提示？"
  ],
  "evaluation_signals": [
    "本轮无需重复基础铺垫即可完成正确判断",
    "当前题目对基础确认有效，但对教学节奏与类比适配的区分信息有限"
  ],
  "feeds": "用于判断后续是否应减少基础回顾、增加案例驱动的分步应用题，并观察节奏是否仍匹配当前稳定状态。"
}
```
...
```json
{
  ...
  "plan_id": "602466ff611d432cb0fa8fa7ce7e6119",
  "plan_version": 2
}
```
